# Day 23 — Integrated Sprint: Full Speaking Section
...
**Source:** BBC Radio 4 In Our Time — search "In Our Time science episode" and pick any science episode

**Week 5 Phonology Focus: Connected Speech — Assimilation**

1. Assimilation drill: find a phrase where a word-final consonant changes to match the following word-initial consonant (e.g., "ten boys" → "tem boys", "good morning" → "goom morning"). Shadow and exaggerate briefly, then normalise.
2. Palatalisation: find sequences like /t j/ → /tʃ/ ("did you" → "didja") or /d j/ → /dʒ/ ("would you" → "wouldja"). Shadow the contracted forms as heard, not as written.
3. Nasal assimilation: find a phrase where /n/ becomes /m/ before bilabial sounds (e.g., "in particular" → "im particular"). Shadow and record to verify.

**Protocol (condensed for Phase 3):**
1. Listen once (2 min)
2. Shadow at full speed — no slow speed in Phase 3 (8 min)
3. Record 30 seconds. Check assimilation — are cross-word boundary sound changes landing naturally? (5 min)
